    ...
    for year_tt in Top_yr_t: #year
        ...
        for file_tt in Top_yr_list_tt:
            ...
            for c in Trans_top['data']['districts']:
                ...
                clm_3['District'].append(name_2)
                clm_3['Transaction_count'].append(count_2)
                clm_3['Transaction_amount'].append(amount_2)
...
#Succesfully created a dataframe
Top_Trans_dis=pd.DataFrame(clm_3)
...
clm_5={'State':[], 'Year':[],'Quarter':[],'District':[], 'Users':[]}
...
for state_tu in Top_state_list_u: #state
    ...
    for year_tu in Top_yr_u: #year
        ...
        for file_tu in Top_yr_list_tu:
            ...
            clm_5['District'].append(name_4)
            clm_5['Users'].append(count_4)
...
#Succesfully created a dataframe
Top_user_dis=pd.DataFrame(clm_5)
